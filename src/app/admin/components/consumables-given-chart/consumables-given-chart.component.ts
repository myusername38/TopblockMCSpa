...
@Component({
  selector: "app-consumables-given-chart",
  templateUrl: "./consumables-given-chart.component.html",
  styleUrls: ["./consumables-given-chart.component.scss"],
})
export class ConsumablesGivenChartComponent implements OnInit {
